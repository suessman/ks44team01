...
public class AccommodationReservationList {
	...
	public String toString() {
		return "AccommodationReservationList [accommodationReservationCode=" + accommodationReservationCode
				+ ", accommodationDetailCode=" + accommodationDetailCode + ", id=" + id + ", name=" + name
				+ ", accommodationOption=" + accommodationOption + ", reservationDatetime=" + reservationDatetime
				+ ", checkinDatetime=" + checkinDatetime + ", checkoutDatetime=" + checkoutDatetime + ", totalNumber="
				+ totalNumber + ", paymentAmount=" + paymentAmount + ", usingPoint=" + usingPoint
				+ ", totalPaymentPrice=" + totalPaymentPrice + ", accommodationPaymentCode=" + accommodationPaymentCode
				+ "]";
	}
